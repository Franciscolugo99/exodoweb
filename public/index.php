...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/app.css?v=20260923-6">
...
<body>
    ...
    <header class="site-header" role="banner">
        <div class="header-inner">
            <a href="/" class="logo" aria-label="ÉXODO Burgers inicio"><img src="/assets/img/logo-exodo.png" alt="ÉXODO Burgers" width="72" height="72"></a>
            ...
            <form id="customizeForm">
                <section class="customize-options" id="customizeOptions" aria-labelledby="customizeOptionsTitle" hidden>
                    <div class="customize-section-heading">
                        ...
                        <p>Tocá cada ingrediente para cambiarlo.</p>
                    </div>
                ...
                <div class="customize-empty" id="customizeEmpty" hidden>
                    <span class="customize-empty-icon" aria-hidden="true">☝</span>
                    <div><strong>Lista de ingredientes pendiente</strong><p>Podés escribir abajo cualquier ingrediente que quieras quitar; cocina verá el pedido.</p></div>
                </div>
    ...
    <!-- Seguimiento -->
    <dialog class="modal" id="trackingModal" aria-labelledby="trackingTitle">
        <div class="modal-content">
            <h2 id="trackingTitle">Seguimiento del pedido</h2>
            <div id="trackingContent" aria-live="polite"></div>
            <button type="button" class="btn btn-secondary" id="trackingClose">Cerrar</button>
        </div>
    </dialog>
    ...
    <script src="/assets/js/app.js?v=20260923-6" defer></script>
</body>
</html>
